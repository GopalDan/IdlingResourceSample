...
public class SimpleIdlingResource implements IdlingResource {
    ...
    //We also created an instance of AtomicBoolean in order to control idleness across multiple threads. Idleness is controlled with this boolean.
    /**
     * In the code above we also initiate an AtomicBoolean object to control the state of idleness. This class provides us with a
     * boolean variable that can be read and written to automatically. AtomicBooleans are used when multiple threads need to check
     * and change the boolean. This happens to be perfect for our situation.
     */
